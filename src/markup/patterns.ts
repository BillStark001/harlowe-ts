...
/**
	...
	*/
function notChars(/** variadic */...args: string[]) {
...
/**
	...
	*/
function makeWrapper(starter: string) {
	return function (/** variadic */...args: string[]) {
		return "(" + starter + Array.apply(0, args).join("|") + ")";
	};
}

const either = makeWrapper("?:"),
...
const Patterns = Object.freeze({
	...
	PlainCompare: Object.freeze<Record<string, string>>({
		comma: ",",
		/**
